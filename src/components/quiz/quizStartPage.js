        ...
        <div className="container">
            <form onSubmit={startQuiz}>
                ...
                <div>
                    ...
                    <div className="form-check">
                        <input type="radio" className="form-check-input" id="nrQuestions1" name="nrQuestions" value="4" defaultChecked />
                        <label className="form-check-label" htmlFor="nrQuestions1">4</label>
                    </div>
                    <div className="form-check">
